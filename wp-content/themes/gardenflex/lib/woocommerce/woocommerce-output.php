...
function genesis_sample_woocommerce_styles( $enqueue_styles ) {
	...
	$enqueue_styles['gardenflex-woocommerce-styles'] = array(
		'src'     => get_stylesheet_directory_uri() . '/lib/woocommerce/gardenflex-woocommerce.css',
		'deps'    => '',
...
function genesis_sample_woocommerce_css() {
	...
	if ( $woo_css ) {
		wp_add_inline_style( 'gardenflex-woocommerce-styles', $woo_css );
	}
