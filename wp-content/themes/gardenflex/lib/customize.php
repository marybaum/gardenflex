...
function genesis_sample_customizer_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'genesis_sample_link_color',
			array(
				'description' => __( 'Change the color of post info links, hover color of linked titles, hover color of menu items, and more.', 'gardenflex' ),
				'label'       => __( 'Link Color', 'gardenflex' ),
				'section'     => 'colors',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'genesis_sample_accent_color',
			array(
				'description' => __( 'Change the default hovers color for button.', 'gardenflex' ),
				'label'       => __( 'Accent Color', 'gardenflex' ),
				'section'     => 'colors',
